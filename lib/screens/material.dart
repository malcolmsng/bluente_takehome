...
import 'package:bluente_takehome/screens/planets.dart';
import 'package:percent_indicator/percent_indicator.dart';

class MaterialsPage extends StatefulWidget {
  int score;
  MaterialsPage({Key? key, required this.score}) : super(key: key);
...
class _MaterialsPageState extends State<MaterialsPage> {
  int correctIndex = 2;
  var gridTitle = ['Granite', 'Steel', 'Diamond', 'Gold'];
  var gridColours = [
    Colors.grey[200],
    Colors.grey[200],
    Colors.grey[200],
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text("Which of the following materials is the hardest?",
                  textAlign: TextAlign.center,
                  style: TextStyle(
